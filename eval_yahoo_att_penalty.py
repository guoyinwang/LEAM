...
class Options(object):
    def __init__(self):
        ...
        self.save_path = "./save/yahoo_emb_plot_recover"
        self.log_path = "./log/yahoo_emb_plot_recover"
        self.print_freq = 100
        self.valid_freq = 100
...
def main():
    ...
    with tf.device('/gpu:1'):
        ...
        accuracy_, loss_, train_op, W_norm_, global_step, Att_h_, Att_v_, H_enc_, W_class_ = emb_classifier(x_, x_mask_, y_, keep_prob, opt, class_penalty_)
                    ...
                    if uidx % opt.valid_freq == 0:
                        ...
                        if val_accuracy > max_val_accuracy:
                            ...
                            for _, test_index in kf_test:
                                ...
                                test_accuracy, Att_h, Att_v, H_enc= sess.run([accuracy_, Att_h_, Att_v_, H_enc_],feed_dict={x_: x_test_batch, x_mask_: x_test_batch_mask,y_: test_labels, keep_prob: 1.0, class_penalty_: 0.0})
                            ...
                            if test_accuracy > 0.745:
                                ...
                                np.savez('yahoo_emb_results_penalty_1.npz', test_emb = test_emb, test_y=test_y, class_emb=W_class, class_name=opt.class_name)
