...
from utils import prepare_data_for_cnn, prepare_data_for_rnn, get_minibatches_idx, normalizing, restore_from_save, \
    prepare_for_bleu, cal_BLEU, sent2idx, tensors_key_in_file, prepare_data_for_emb, load_embedding_vectors_glove_gensim, load_class_embedding, _clip_gradients_seperate_norm, embedding_view
...
class Options(object):
    def __init__(self):
        ...
        self.save_path = "./save/yelp_10"
        self.log_path = "./log/yelp_10"
        self.print_freq = 100
        self.valid_freq = 100
...
def emb_classifier(x, x_mask, y, dropout, opt, class_penalty):
    ...
    logits = discriminator_2layer(H_enc, opt, dropout, prefix='classify_', num_outputs=1, is_reuse=False)  # batch * 10
    ...
    return accuracy, loss, train_op, W_norm, global_step, Att_h, Att_v
...
def main():
    ...
    with tf.device('/gpu:1'):
        ...
        accuracy_, loss_, train_op, W_norm, global_step, Att_h_, Att_v_ = emb_classifier(x_, x_mask_, y_, keep_prob, opt, class_penalty_)
                    ...
                    if uidx % opt.valid_freq == 0:
                        ...
                        if val_accuracy > max_val_accuracy:
                            ...
                            for _, test_index in kf_test:
                                ...
                                test_accuracy, Att_h, Att_v= sess.run([accuracy_, Att_h_, Att_v_],feed_dict={x_: x_test_batch, x_mask_: x_test_batch_mask,y_: test_labels, keep_prob: 1.0})
